...
type (
	...
	//AUTH -.
	Auth interface {
		Login(context.Context, models.LoginRequest, *models.User) (*models.Session, error)
		CheckSessions(context.Context, string) error
		Refresh(context.Context, string) (*models.Session, error)
	...
	GetWetherRepo interface {
	}

	GetWeather interface {
		GetMeWeather(context.Context, string) (*models.Weather, error)
	}
)
