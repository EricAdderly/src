...
import (
	...
	v2 "e-project/internal/controller/http/v2"
	v3 "e-project/internal/controller/http/v3"
)
...
func Run(cfg *config.Config) {
	...
	GetweatherUseCase := usecase.NewGetWeather(repo.NewGetWeatherRepo(pg))
	...
	v3.NewGetWeatherRouter(handler, l, GetweatherUseCase)
